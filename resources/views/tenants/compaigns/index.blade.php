...
@section('content')
    <div class="page-header">
        <div class="page-title">
            <h4>{{ __('compaign.campaigns') }}</h4>
            <h6>{{ __('compaign.campaigns') }}</h6>
        </div>
        <div class="page-btn">
            @haspermission('campaigns_create')
                <a href="{{ route('campaigns.create') }}" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img"
                    class="me-1">{{ __('compaign.create') }}</a>
            @endhaspermission
        </div>
    </div>
            ...
            <div class="table-top">
                ...
                <div class="wordset">
                    ...
                    @haspermission('campaign_view')
                        <li><a data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('compaign.campaigns') }}" href="{{ route('campaigns.index') }}" ><img src="assets/img/icons/listing.svg" class="icon-adjustment" alt="img"></a></li>
                    @endhaspermission
                    ...
                    @haspermission('campaign_export_csv')
                        <li><a data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('compaign.btn-export-csv') }}" href="{{ route('export-campaigns', ['id' => 1, 'format' => 'csv']) }}"><img src="assets/img/icons/csv.svg" class="icon-adjustment" alt="img"></a></li>
                    @endhaspermission
                
                
                    @haspermission('campaign_export_excel')
                        <li><a data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('compaign.btn-export-xlsx') }}" href="{{ route('export-campaigns', ['id' => 1, 'format' => 'xlxs']) }}"><img src="assets/img/icons/excel2.svg" class="icon-adjustment" alt="img"></a></li>
                    @endhaspermission
                    @haspermission('campaign_export_pdf')
                    <li><a data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('compaign.btn-export-pdf') }}" href="{{ route('tenants.pdf') }}" download ><img src="assets/img/icons/pdf.svg" class="icon-adjustment" alt="img"></a></li>
                    @endhaspermission
                    @haspermission('campaign_import_csv')
                        <li><a data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('compaign.btn-import-cvs') }}" href="{{ route('file-import') }}" ><img src="assets/img/icons/import.svg" class="icon-adjustment" alt="img"></a></li>
                    @endhaspermission
