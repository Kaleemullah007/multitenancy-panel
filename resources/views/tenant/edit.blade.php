        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('tenants.update', $tenant->id) }}" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                name="name" value="{{ old('name', $tenant->name) }}" required autocomplete="name"
                                autofocus>
                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                name="email" value="{{ old('email', $tenant->email) }}" required autocomplete="email">
                    ...
                    <div class="col-lg-3 col-sm-3 col-6">
                        <div class="form-group">
                            <label for="update_plan">{{ __('tenant.form.update-plan') }} </label>
                            <div class="d-flex">
                                <span class="text-danger">({{ $tenant->user?->start_date }} ,
                                    {{ $tenant->user?->end_date }})</span>
                                <input type="checkbox" name="update_plan" class="ml-[100px]" style="margin-left: 100px;"
                                    id="update_plan" @checked(old('update_plan') == true)>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 text-center ">
                        <div class="form-group d-inline">
                            <label for="status" class="">{{ __('tenant.form.status') }} <input id="status"
                                    type="checkbox" class=" @error('status') is-invalid @enderror" name="status"
                                    @checked($tenant->status == true)></label>
