$("#basic-alert").on("click", function() {
    ...
    Swal.fire({
        ...
        $('._delete_data').click(function(e){
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "You can restore or permanently delete this record",
                type: 'warning',
        ...
        $('._delete_p').click(function(e){
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Do you want to delete this record permanently, Every data will be lost for this tenant user",
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
        ...
        $('._delete_r').click(function(e){
            var data_id = $(this).attr('data-id');
            Swal.fire({
                title: 'Are you sure?',
                text: "Do you want to restore this tenant user",
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if(result.value)
                    {
                    $("#rdelete_from_"+data_id).submit();
                }
            })
        });

        $('._renew').click(function(e){
            var data_id = $(this).attr('data-id');
            Swal.fire({
                title: 'Are you sure?',
                text: "Do you want to renew the plan this tenant user",
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if(t.value)
                    {
                        document.getElementById('renew'+data_id).click();
